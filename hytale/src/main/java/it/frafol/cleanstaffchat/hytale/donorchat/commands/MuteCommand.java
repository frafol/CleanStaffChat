...
public class MuteCommand extends AbstractCommand {
    ...
    public MuteCommand(CleanStaffChat plugin, String name, String description, List<String> aliases) {
        ...
        this.requirePermission(Objects.requireNonNull(HytaleConfig.DONORCHAT_MUTE_PERMISSION.get(String.class)));
        if (aliases != null) {
    ...
    protected CompletableFuture<Void> execute(@Nonnull CommandContext context) {
        ...
        if (!PermissionsUtil.hasPermission(sender.getUuid(), HytaleConfig.DONORCHAT_MUTE_PERMISSION.get(String.class))) {
