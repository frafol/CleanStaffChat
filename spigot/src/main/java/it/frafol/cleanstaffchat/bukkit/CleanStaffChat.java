...
public class CleanStaffChat extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        Library updater = Library.builder()
                ...
                .relocate("updater", "it{}frafol{}libs{}updater")
        ...
        Library discord = Library.builder()
                ...
                .artifactId("JDA")
                .version("6.0.0-rc.4")
                .relocate("kotlin", "it{}frafol{}libs{}kotlin")
        ...
        Library scheduler = Library.builder()
                ...
                .version("0.1.6")
                .relocate("scheduler", "it{}frafol{}libs{}scheduler")
                .build();
        ...
        if (SpigotConfig.WORKAROUND_KICK.get(Boolean.class)) {
            ...
            getLogger().info("Successfully enabled in Proxy mode (Kick Workaround)!");
            return;
        }

        if (SpigotConfig.DOUBLE_MESSAGE.get(Boolean.class)) {
            getServer().getMessenger().registerIncomingPluginChannel(this, "cleansc:cancel", new PluginMessageReceiver());
            getServer().getPluginManager().registerEvents(new it.frafol.cleanstaffchat.bukkit.objects.ChatListener(), this);
            getLogger().info("Successfully enabled in Proxy mode (Double Message Workaround)!");
            return;
        }
